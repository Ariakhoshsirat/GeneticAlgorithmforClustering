...
mu1 = [1 -1];
sigma = [0.2^2 0 ; 0 0.2^2];
%traindata1 =  [mvnrnd(mu1,sigma1,50) ones(50,1)];
data1 = mvnrnd(mu1,sigma,20);
clear mu1 ;

mu2 = [-1.5 0];
%sigma2 = [2 0 ; 0 2];
%traindata2 =  [mvnrnd(mu2,sigma2,50) ones(50,1)*2];
data2 = mvnrnd(mu2,sigma,20);
clear mu2;

mu3 = [0 1];
%sigma3 = [2 0 ; 0 2];
%traindata1 =  [mvnrnd(mu1,sigma1,50) ones(50,1)];
data3 = mvnrnd(mu3,sigma,20);
clear mu3;

mu4 = [-1 1];
data4 = mvnrnd(mu4,sigma,30);
clear mu4;

mu5 = [2 -1];
data5 = mvnrnd(mu5,sigma,20);
clear mu5;

mu6 = [-2 -1];
data6 = mvnrnd(mu6,sigma,30);
clear mu6;

mu7 = [-0.5 2];
data7 = mvnrnd(mu7,sigma,20);
clear mu7;

mu8 = [-1 -1];
data8 = mvnrnd(mu8,sigma,20);
clear mu8;

mu9 = [1.5 0];
data9 = mvnrnd(mu9,sigma,20);
clear mu9;
%}
data = [data1;data2;data3;data4;data5;data6;data7;data8;data9];
clear data1 data2 data3 data4 data5 data6 data7 data8 data9 sigma;
...
labels9 = ones(20,1)*9;
k = 3;
labels = [labels1 ; labels2 ; labels3 ;labels4 ; labels5 ; labels6; labels7 ; labels8; labels9];
clear labels1 labels2 labels3 labels4 labels5 labels6 labels7 labels8 labels9;
%}
%{
load('iris2.data');
data = iris2(:,1:4);
